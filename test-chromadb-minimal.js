...
/**
 * Minimal ChromaDB Test Script
 * 
 * This script tests ChromaDB with minimal metadata to avoid 422 errors.
 */
...
async function minimalTest() {
  console.log('🚀 Minimal ChromaDB Test');
  ...
  try {
    ...
    // Generate embeddings for first 2 chunks
    console.log('🤖 Generating embeddings...');
    const sampleChunks = processedDoc.chunks.slice(0, 2);
    ...
    // Store in ChromaDB with minimal metadata
